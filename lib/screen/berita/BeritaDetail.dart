...
class BeritaDetail extends StatefulWidget {
  static String tag = '/BeritaDetail';
  ...
  // ignore: non_constant_identifier_names
  BeritaDetail({this.id_berita,this.judul_berita,this.isi,this.tanggal,this.waktu,
    // ignore: non_constant_identifier_names
    ...
    this.reporter_foto,
    // ignore: non_constant_identifier_names
    this.fotografer_foto,this.title,this.ket_foto});

  @override
  BeritaDetailState createState() => BeritaDetailState();
}




class BeritaDetailState extends State<BeritaDetail> with TickerProviderStateMixin<BeritaDetail> {
  String data;
  // ignore: non_constant_identifier_names
  var Beritalength;
  // ignore: non_constant_identifier_names
              ...
              child: Container(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                        padding: EdgeInsets.only(left: 7.0, right: 7.0, bottom: 0),
                        child: Html(
                          data: widget.ket_foto,
                          style: {
                            "html": Style(
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) => BeritaDetail(
                                          ...
                                          [index]['permalink'],
                                          kategori: jsonDecode(data)['posts']
                                          [index]['title'],
                                          editor: jsonDecode(data)['posts']
                                          [index]['editor'],
                                          reporter: jsonDecode(data)['posts']
                                          [index]['reporter'],
                                          fotografer:
                                          jsonDecode(data)['posts'][index]
                                          ['fotografer'],
