...
import '../../main.dart';
import 'OpiniDetail.dart';

class Opini extends StatefulWidget {
  static String tag = '/Opini';
  @override
  OpiniState createState() => OpiniState();
}

class OpiniState extends State<Opini> {
  String apiUrl = mBaseUrl + "get_recent_opini";
  int pageNo = 2;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text("Opini", style: boldTextStyle(color: db6_white, size: 24, fontFamily: fontBold)),
        ),
      body: Container(
          child: _buildList(),
        ),
