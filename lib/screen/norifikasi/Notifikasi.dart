...
class NotifikasiState extends State<Notifikasi> {
  ...
  Widget appBarTitle = Text("Terpopuler",
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Terpopuler", style: boldTextStyle(color: db6_white, size: 24, fontFamily: fontBold)),
      ),
      body: Container(
        child: _buildList(),
      ),
